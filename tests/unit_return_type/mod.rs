...
#[test]
fn simple_return_unit_type_fixer() {
    test_lint_fixer!(SIMPLE_RETURN_UNIT_TYPE, @r#"
    fn test_fn() {
        ()
    }
...
#[test]
fn simple_return_unit_type_with_implicit_unit_type_fixer() {
    test_lint_fixer!(SIMPLE_RETURN_UNIT_TYPE_WITH_IMPLICIT_UNIT_TYPE, @r#"
    fn test_fn() {
        ()
    }
...
#[test]
fn simple_return_unit_type_allowed_fixer() {
    test_lint_fixer!(SIMPLE_RETURN_UNIT_TYPE_ALLOWED, @r##"
    #[allow(unit_return_type)]
    fn test_fn() -> () {
        ()
    }
...
#[test]
fn return_unit_type_in_trait_fixer() {
    test_lint_fixer!(RETURN_UNIT_TYPE_IN_TRAIT, @r#"
    trait MyTrait {
        fn test_fn();
    }
...
#[test]
fn return_unit_type_in_trait_allowed_fixer() {
    test_lint_fixer!(RETURN_UNIT_TYPE_IN_TRAIT_ALLOWED, @r#"
    trait MyTrait {
        #[allow(unit_return_type)]
        fn test_fn() -> ();
    }
...
#[test]
fn return_unit_type_in_impl_fixer() {
    test_lint_fixer!(RETURN_UNIT_TYPE_IN_IMPL, @r#"
    trait MyTrait {
        fn test_fn();
    }
...
#[test]
fn return_unit_type_in_impl_allowed_fixer() {
    test_lint_fixer!(RETURN_UNIT_TYPE_IN_IMPL_ALLOWED, @r#"
    trait MyTrait {
        fn test_fn();
    }
